...
window.onload = () => {
    ...
    setTimeout(() => {
        addBotMessage(
            ...
            "📝 <b>Create Lead</b><br>" +
            "→ create lead name Ravi phone 9876543210 " +
            "email ravi@gmail.com city Chennai<br><br>" +
            "📋 <b>Show Leads</b><br>" +
            "→ show leads<br><br>" +
            "🗑 <b>Delete Lead</b><br>" +
            "→ delete Ravi<br><br>" +
            "🏆 <b>Update Deal Status</b><br>" +
            "→ Ravi won (or) Ravi lost<br><br>" +
            "📅 <b>Follow Up</b><br>" +
...
async function loadLeads() {
    ...
    try {
        ...
        let html = "📋 <b>Total Leads: " +
                   leads.length + "</b><br><br>";
        leads.forEach((lead, index) => {
            ...
            html += "🔄 Status    : " +
                    (lead.status || "-") + "<br>";
            html += "💼 Deal      : " +
                    (lead.dealStatus || "PENDING") + "<br>";
            html += "📅 Follow Up : " +
                    (lead.followUp || "None") + "<br>";
            html += "🕐 Created   : " +
                    (lead.createdAt
